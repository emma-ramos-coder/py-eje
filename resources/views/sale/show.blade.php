                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary my-3" href="{{ route('sales.index') }}"> {{ __('Volver') }}</a>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <table id="saleDetails" class="table table-striped">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="3">
                                            <p class="text-right">IGV:</p>
                                        </th>
                                        <th>
                                            <p class="text-right">S/ {{number_format($sale->igv,2)}}</p>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="3">
                                        ...
                                        <th>
                                            <p class="text-right">S/ {{number_format($sale->total_invoice,2)}}</p>
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">S/ {{number_format($saleDetail->price,2)}}</td>
                                        <td class="text-center">{{$saleDetail->quantity}}</td>
                                        <td class="text-right">S/ {{number_format($saleDetail->quantity*$saleDetail->price,2)}}
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
