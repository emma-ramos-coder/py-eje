                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('way-to-pays.destroy',$wayToPay->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('way-to-pays.show',$wayToPay->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('way-to-pays.edit',$wayToPay->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
